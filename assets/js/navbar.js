export function renderNavbar(user) {
  return `
    <header
      ...
      <!-- Desktop Menu -->
      <nav class="hidden md:flex gap-6 text-gray-300 font-medium items-center">
      ...
      <!-- Search Bar (Desktop) -->
      <div class="hidden md:flex items-center bg-yellow-400 rounded-full px-4 py-1 ml-6 shadow-md">
        <input 
          type="text" 
          id="navbarSearchInput" 
          placeholder="Search movies..." 
          class="bg-transparent focus:outline-none text-gray-900 placeholder-gray-800 px-2 py-1 rounded-l-full"
        >
        <button id="navbarSearchBtn" class="px-3 py-1 bg-yellow-500 rounded-r-full hover:bg-yellow-600 transition">
      ...
      <!-- Profile Dropdown -->
      <div class="relative">
        <button id="profileBtn" class="flex items-center gap-2 ml-4">
      ...
      <!-- Mobile Menu Button -->
      <button class="md:hidden text-white text-2xl ml-2" id="menuToggle">
