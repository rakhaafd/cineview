  ...
  return `
    ...
    m.Title
          ...
          <div class="flex-1 space-y-3">
            <h3 class="text-3xl font-extrabold text-yellow-300">${
              m.Title
            } <span class="text-white">(${m.Year})</span></h3>
            <p><span class="font-semibold text-purple-400">⭐ IMDB:</span> ${
              m.imdbRating
            } (${m.imdbVotes} votes)</p>
            <p><span class="font-semibold text-purple-400">Rated:</span> ${
              m.Rated
            }</p>
            <p><span class="font-semibold text-purple-400">Released:</span> ${
              m.Released
            }</p>
            <p><span class="font-semibold text-purple-400">Runtime:</span> ${
              m.Runtime
            }</p>
            <p><span class="font-semibold text-purple-400">Genre:</span> ${
              m.Genre
            }</p>
            <p><span class="font-semibold text-purple-400">Director:</span> ${
              m.Director
            }</p>
            <p><span class="font-semibold text-purple-400">Writer:</span> ${
              m.Writer
            }</p>
            <p><span class="font-semibold text-purple-400">Actors:</span> ${
              m.Actors
            }</p>
            <p><span class="font-semibold text-purple-400">Awards:</span> 🏆 ${
              m.Awards
            }</p>
            ...
            <p class="mt-4 text-gray-300"><span class="font-semibold text-purple-400">Plot:</span> ${
              m.Plot
            }</p>
          </div>
        </div>
